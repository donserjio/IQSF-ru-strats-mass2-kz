      ...
      <div className="w-full max-w-4xl max-h-[85vh] flex flex-col bg-card border border-border/50 rounded-md shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 text-sm text-muted-foreground leading-relaxed custom-scrollbar">
          ...
          <div>
            ...
            <p>Цифрлық активтермен алгоритмдік сауда салынған капиталдың барлығын немесе едәуір бөлігін жоғалту мүмкіндігін қоса алғанда айтарлықтай тәуекелдермен байланысты. Цифрлық активтер жоғары өзгергіш және алыпсатарлық сипатта болады. Бұл қызмет тек барлық бөлуді жоғалта алатын клиенттерге ғана жарамды.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>Стратегиялардың өз мақсаттарына жетуіне кепілдік берілмейді. Мақсатты табыстылық пен тәуекел метрикалары — мақсаттар, кепілдіктер емес. Қолайсыз нарық жағдайларында айтарлықтай шегінулер болуы мүмкін.</p>
          </div>
          <div>
