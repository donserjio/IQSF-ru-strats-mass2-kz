...
const STRATEGIES: Record<string, StrategyConfig> = {
  basket50: {
    ...
    approachShort: "Көпжүйелі алгоритмдік тәсіл",
    approachFull: "бірнеше алгоритмдік модельдің үйлесімі",
    ...
    strategyType: "Алгоритмдік, жүйелі",
    holdingPeriod: "< 3 күн",
    capacity: "$200M",
  },
  basket70tf: {
      ...
      <Popover open={calOpen} onOpenChange={setCalOpen}>
        <PopoverTrigger asChild>
          ...
          >
            ...
            {active === "custom" && range?.from ? rangeLabel : "Кезең"}
          </button>
        </PopoverTrigger>
...
function ZoomableChart({
  ...
  return (
    <div>
      ...
      {!isZoomed && (
        <p className="text-[10px] text-muted-foreground/40 text-center mt-2">Үлкейту үшін графикті басып сүйреңіз</p>
      )}
    </div>
  );
}
